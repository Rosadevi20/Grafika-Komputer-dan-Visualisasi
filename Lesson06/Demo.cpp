...
void Demo::DrawBuilding()
{
	...
	for (int i = 0; i < 1; i++) {
		objectColorLoc = glGetUniformLocation(this->shaderProgram, "objectColor");
		glUniform3f(objectColorLoc, 0.0f, 100.0 / 255.0f, 0.0f);

		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(3, -0.4, -0.4));
		//model2 = glm::rotate(model2, angle, glm::vec3(0, 1, 0));
		model2 = glm::scale(model2, glm::vec3(3, 0, 4));
	...
	for (int i = 0; i < 1; i++) {
		...
		model2 = glm::translate(model2, glm::vec3(-3, -0.4, 0.5));
		//model2 = glm::rotate(model2, angle, glm::vec3(0, 1, 0));
		model2 = glm::scale(model2, glm::vec3(4, 0, 4));
...
void Demo::DrawBuildingPutih()
{
	...
	for (int i = 0; i < 1; i++) {
		...
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(4, -0.2, 4));
		//model2 = glm::rotate(model2, angle, glm::vec3(0, 1, 0));
		model2 = glm::scale(model2, glm::vec3(2.5, 0, 2.5));
...
void Demo::DrawTree()
{
	...
	for (int i = 0; i < 4; i++) {
		...
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(-0.7, 0.6 + i * 0.2, -1));
		//model2 = glm::rotate(model2, angle, glm::vec3(0, 1, 0));
	...
	for (int i = 0; i < 1; i++) {
		...
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(-0.7, 1.2 + i * 0.2, -1));
		//model2 = glm::rotate(model2, angle, glm::vec3(0, 1, 0));
		model2 = glm::scale(model2, glm::vec3(0.8, 0.2, 0.6));
	...
	for (int i = 0; i < 1; i++) {
		...
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(-0.7, 1.4 + i * 0.2, -1));
		//model2 = glm::rotate(model2, angle, glm::vec3(0, 1, 0));
		model2 = glm::scale(model2, glm::vec3(0.6, 0.2, 0.4));
	...
	for (int i = 0; i < 1; i++) {
		...
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(-0.7, 1.6 + i * 0.2, -1));
		//model2 = glm::rotate(model2, angle, glm::vec3(0, 1, 0));
		model2 = glm::scale(model2, glm::vec3(0.4, 0.2, 0.2));
	...
	for (int i = 0; i < 1; i++) {
		...
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(-0.7, 1.7 + i * 0.2, -1));
		//model2 = glm::rotate(model2, angle, glm::vec3(0, 1, 0));
		model2 = glm::scale(model2, glm::vec3(0.2, 0.2, 0.2));
...
void Demo::DrawStreet()
{
	...
	//model = glm::rotate(model,angle, glm::vec3(0, 1, 0));
	model = glm::scale(model, glm::vec3(1.8, 0.1, 30));
	...
	for (int i = 0; i < 13; i++) {
		...
		glm::mat4 model2;
		model2 = glm::translate(model2, glm::vec3(0.2, 0.6, 6 - i));
		//model2 = glm::rotate(model2, angle, glm::vec3(0, 1, 0));
